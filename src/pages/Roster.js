      ...
      {selected && modal==='tour' && (
        <div className="modal-overlay" onClick={()=>setModal(null)}>
          <div className="modal" onClick={e=>e.stopPropagation()}>
            ...
            <button className="btn btn-gold btn-lg w-full" onClick={()=>{bookTour(selected.id,tourTier);close();}} disabled={game.cash<tourTier.cost} style={{ marginTop:16, opacity:game.cash>=tourTier.cost?1:0.5 }}>
